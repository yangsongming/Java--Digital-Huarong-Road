...
public class PreCg2Slice extends AbilitySlice implements Component.ClickedListener {
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_c2);
...
//        dataItems.add(new TestPageProvider.DataItem(ResourceTable.Media_ultraman));
    ...
    public void onClick(Component component) {
        if (component == btn_back) {
            ...
            AbilitySlice slice = new Hrcg2Slice();
            Intent intent = new Intent();
