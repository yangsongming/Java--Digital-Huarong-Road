...
public class PrechooseSlice extends AbilitySlice implements Component.ClickedListener {
    static final HiLogLabel label = new HiLogLabel(HiLog.LOG_APP,0,"SelectSlice: ");
    private Button btn_back, btn_play, quesbtn;
    private int diff = 3, diffNewVal;
    ...
    public void onStart(Intent intent) {
        ...
        super.setUIContent(ResourceTable.Layout_preselect_slice);
    ...
    public void onClick(Component component) {
        ...
        else if (component == btn_play) {         //向HrSlice传递相关参数
            AbilitySlice slice = new HrSlice();
                Intent intent = new Intent();
